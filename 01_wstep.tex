...
%\end{enumerate}}
\item \emph{Generatory liczb pseudolosowych}
\end{enumerate}
\end{frame}
\begin{frame}{Harmonogram wykładów}
\begin{description}
\item[25.02] Organizacja, motywacja, aksjomatyka
\item[19.03] Zmienne losowe typu skokowego
\item[25.03] Zmienne losowe typu ciągłego, twierdzenia graniczne
\item[14.05] Generatory liczb losowych
\end{description}
\end{frame}
\begin{frame}{Harmonogram ćwiczeń}
\begin{description}
\item[11.03] Aksjomatyka, prawdopodobieństwo warunkowe
\item[26.03] Zmienne losowe typu skokowego
\item[08.04] Zmienne losowe dwuwymiarowe
\item[20.05] Zmienne losowe typu ciągłego
\end{description}
\end{frame}
