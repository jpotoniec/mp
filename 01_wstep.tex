...
\begin{frame}{Konkurs!}
	...
	\begin{block}{Nagroda}
		...
		\end{itemize}
	\end{block}
	\note<1>{F-Secure rekrutuje. Konsultanci bezpieczeństwa: \url{jaroslaw.kaminski@f-secure.com}. Programiści (głównie Python i C\#): \url{leszek.tasiemski@f-secure.com}}
\end{frame}
