...
%TODO: poprawić skład
\begin{gather*}
 P((X,Y)\in S)=1 \qquad S=\{(x_1,y_1),(x_1,y_2),\ldots,(x_m,y_n),\ldots\} \\
...
\only<4->{p_{i,\cdot}=\sum_{y_j} p_{i,j} \qquad p_{\cdot,j}=\sum_{x_i} p_{i,j}}
\end{gather*}
\end{frame}
...
\begin{frame}{Kostka}
	...
	% p00=1/6 p10=0 p01=2/6 p11=1/2
	% P(Z=0)=1/6+0+2/6=1/2 P(Z=1)=1/2
\end{frame}
