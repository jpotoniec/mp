...
\begin{onlyenv}<4->
\begin{align*}
y = & [1, 0, 0, 1] = [y_3, y_2, y_1, y_0] \\
yL = & [0, 0, 1, 0] = [y_2, y_1, y_0, 0] \\
\end{align*}
\end{onlyenv}
\begin{onlyenv}<5->
\begin{align*}
...
\end{bmatrix}
$$
\texttt{y>>n = ((y>>1)>>1)>>\ldots>>1} $=y\cdot R\cdot R\cdot\ldots\cdot R=yR^n$ \\
\texttt{y<<n = ((y<<1)<<1)<<\ldots<<1} $=y\cdot L\cdot L\cdot\ldots\cdot L=yL^n$ \\
$R=L^T$
\end{frame}
