...
\For{$n\gets 1\, \KwTo\, 8$}
{
	\lIf{$n\leq 5$}
	{
		$k \gets $ wybierz losową liczbę z $\{0, 1 \ldots, 2^n-1\}$ \label{backoff:delay1}
	}
	\lElse
	{
		$k \gets $ wybierz losową liczbę z $\{0, 1 \ldots, 2^5-1\}$ \label{backoff:delay2}
	}
...
\[ P(A_n=k)=\ldots\ldots\ldots\ldots \qquad P(B_n=k)=\ldots\ldots\ldots\ldots \qquad n=1, 2, 3, 4\, k\in\{0, 1 \ldots, 2^n-1\} \]
