...
\tikzset{
	...
	color2/.style={color=green!50!black!50},
	color3/.style={color=blue!50!black!50},
	set/.style={very thick, decorate},
	diagram/.style={rectangle, rounded corners=3mm, very thick, draw=red!80, top color=red!5, bottom color=red!40},
}
...
\end{scope}
\draw [set,color1,visible on=<3->] (center)  circle (33mm) node (omegalabel) at ($(center)-(37mm,0)$) {$\Omega$};
...
%\begin{center}
%\begin{tikzpicture}
%\draw [set,color1] (0,0)  circle (25mm);
%\begin{scope}[visible on=<2>]
%\draw [set,color2] (0,0) circle (15mm);
%\draw [set,color3] (0,7mm) circle (5mm);
%\end{scope}
%\end{tikzpicture}
%\end{center}
\end{frame}
...
\centering \includegraphics[width=\textwidth,clip,bb=0 0 10cm 11cm]{kolmogorov.jpg} \\
